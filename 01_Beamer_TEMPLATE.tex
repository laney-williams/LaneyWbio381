...
% TITLE PAGE DATA--------------------------
\title[Short title]{Mycorrhizal Fungi Role in Nutrient Acquisition} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Laney Williams} % Your name
...
\medskip
\textit{ilana.williams@uvm.edu} % Your email address
}
...
\section{Nutrients transported by Mycorrhizal Fungi} % Sections can be created in order to organize your presentation into discrete blocks; all sections and subsections are automatically printed in the table of contents as an overview of the talk

\subsection{Nitrogen, phosphorus...} % A subsection can be created just before a set of slides with a common theme to further break down your presentation into chunks

% SLIDE (BULLET POINTS)--------------------
\begin{frame}
\frametitle{types of mycorrhizal fungi}
\begin{itemize}
\item arbuscular
\item ectomycorrhizal
\item ericoid 
\item orchidaceous
\item monotropoid
\end{itemize}
...
\begin{itemize}
\item<1-> How does ericoid mycorrhizal fungi enhance growth traits of V. corymbosum?
\item<2-> How does EMF compensate in a nutrient lacking soil environment?
\item<3-> Are there differences between local and commercial innoculums?
\end{itemize}
\end{frame}

% SLIDE (FIGURE)-----------------------------
\begin{frame}
\frametitle{Highbush blueberry}
% Uncomment the code on this slide to include your own image from the same directory as the template  file.
% \begin{figure}
   \includegraphics[width=1.0\linewidth]{plantpic_1.jpg}
...
%------------------------------------------------
\section{Focus on nitrogen transported by ericoid mycorrhizal fungi}
%------------------------------------------------
...
\end{alltt}
\begin{verbatim}
##  [1] 0.23772922 0.18524737 0.94531123 0.75201144 0.89230828 0.09898049
##  [7] 0.32206012 0.07873980 0.11492265 0.09896463
\end{verbatim}
\end{kframe}
\end{knitrout}
